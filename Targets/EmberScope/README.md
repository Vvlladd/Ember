...
|---|---|
| [![EmberScope's Sessions tab: a model status card reading available, 4,096-token context size, exact token counts supported, 23 languages, and one session row labelled chat with its request and error counts and a compact context-window bar](../../docs/screenshots/emberscope-sessions.png)](../../docs/screenshots/emberscope-sessions.png) | [![EmberScope's session detail: the session header (model, created, last activity, prewarms), a context-window bar showing 559 of 4,096 tokens used with an estimated badge and tool definitions counted inside the instructions entry, the instructions text and the start of the registered tools list](../../docs/screenshots/emberscope-session-detail.png)](../../docs/screenshots/emberscope-session-detail.png) |

| Timeline | Error detail |
|---|---|
| [![EmberScope's Timeline tab, filterable and searchable, listing a context snapshot, a failed request at 157 ms, a classified error, a stream start with its prompt, a retrieval note and a prewarm](../../docs/screenshots/emberscope-timeline.png)](../../docs/screenshots/emberscope-timeline.png) | [![EmberScope's error detail classifying a raw GenerationError as Model assets unavailable, with the full debug description and the root-first error chain: GenerationError, a nested GenerationError, SensitiveContentAnalysisML 15 and ModelManagerError 1026](../../docs/screenshots/emberscope-error-detail.png)](../../docs/screenshots/emberscope-error-detail.png) |
